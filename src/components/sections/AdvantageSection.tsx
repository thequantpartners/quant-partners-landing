  ...
  return (
    <section ref={ref} id="ventaja" className="relative py-32 px-6 overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] rounded-full bg-[#c9a84c]/[0.015] blur-3xl" />
      </div>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
          <div className="max-w-xl">
            ...
            >
              ...
              <br />
              <span className="text-gradient-gold">99% de</span>
              <br />
              <span className="text-white">las agencias</span>
              <br />
              <span className="text-white/25">no pueden</span>
              <br />
          ...
          <motion.div
            ...
            className="md:max-w-[280px] p-6 rounded-3xl border border-[rgba(201,168,76,0.15)] bg-[rgba(201,168,76,0.03)]"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {advantages.map((adv, i) => (
            <motion.div
              ...
              className="group relative p-8 rounded-3xl border border-white/[0.05] bg-white/[0.01] hover:border-[rgba(201,168,76,0.20)] hover:bg-[rgba(201,168,76,0.03)] transition-all duration-300"
            >
              <div className="flex items-start gap-5">
                <div className="w-10 h-10 rounded-xl bg-[rgba(201,168,76,0.08)] border border-[rgba(201,168,76,0.18)] flex items-center justify-center text-[#c9a84c] shrink-0 group-hover:bg-[rgba(201,168,76,0.14)] transition-colors duration-300">
                  {adv.icon}
                </div>
                <div className="flex-1">
                  <div className="flex items-center justify-between gap-4 mb-2">
                    <h3 className="font-bold text-white text-lg">{adv.title}</h3>
                    <span className="text-[10px] text-[#c9a84c]/45 border border-[rgba(201,168,76,0.15)] rounded-pill px-2 py-0.5 whitespace-nowrap">
                      {adv.tag}
                    </span>
                  </div>
              ...
              <div className="absolute bottom-0 left-8 right-8 h-px bg-gradient-to-r from-transparent via-[rgba(201,168,76,0.15)] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </motion.div>
          ))}
        </div>
      </div>
